...
namespace Sequence.Boilerplates
{
    ...
    {
        [SerializeField] private QrCodeView _qrCode;
        ...
        private Currency _bestCurrency;
        ...
        public async void Show(Chain chain, ICheckoutHelper checkoutHelper, IFiatCheckout fiatCheckout, Action onClose = null)
        {
            _chain = chain;
            _cart = checkoutHelper;
            _onClose = onClose;
            ...
            _indexer = new ChainIndexer(chain);
        ...
        private async void OpenQrCodePage()
        {
            await _qrCode.Show(_bestCurrency.contractAddress, _wallet.GetWalletAddress().Value, "1000");
        }
    }
}