...
{
    public class ScaleVertically : MonoBehaviour, ITween
    {
        ...
        public void Initialize(RectTransform rectTransform)
        {
            ...
            _transform.localScale = new Vector3(startingScale.x, 0, 0);
        }
        ...
        {
            Vector3 startingScale = _transform.localScale;
            Vector3 targetScale = new Vector3(startingScale.x, target, 1);
