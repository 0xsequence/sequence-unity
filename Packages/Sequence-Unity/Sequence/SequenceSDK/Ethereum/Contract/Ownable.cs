...
{
    public class Ownable : ContractWrapper
    {
        ...
        public Ownable(Contract contract) : base(contract)
        {
        ...
        public Ownable(string contractAddress, string abi = null) : base(contractAddress, abi)
        {
            if (abi == null)
            {
