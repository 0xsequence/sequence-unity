        ...
        public async void DeployERC20()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(deployResult.result.txHash))
                {
                    ...
                    if (receipt != null)
                    {
                        string deployedAddress = DeployedeContractAddressExtractor.ExtractFirstContractAddressExceptOwn(receipt, DeployERC20InitialOwner);
        ...
        public async void DeployERC721()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(deployResult.result.txHash))
                {
                    ...
                    if (receipt != null)
                    {
                        string deployedAddress = DeployedeContractAddressExtractor.ExtractFirstContractAddressExceptOwn(receipt, DeployERC721DefaultAdmin);
                        if (!string.IsNullOrEmpty(deployedAddress))
                        {
                            Debug.Log($"Deployed contract address: {deployedAddress}");
                        }
        ...
        public async void DeployERC1155()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(deployResult.result.txHash))
                {
                    ...
                    if (receipt != null)
                    {
                        string deployedAddress = DeployedeContractAddressExtractor.ExtractFirstContractAddressExceptOwn(receipt, DeployDefaultAdmin);
                        if (!string.IsNullOrEmpty(deployedAddress))
                        {
                            Debug.Log($"Deployed contract address: {deployedAddress}");
                        }
