...
namespace TowerDefense.UI
{
	...
	public class EndGameScreen : MonoBehaviour
	{
		...
		/// </summary>
		protected void OpenEndGameScreen(string endResultText, int overrideStars = -1)
		{
		...
		/// </summary>
		protected void Victory(int overrideStars = -1)
		{
			OpenEndGameScreen(levelCompleteText, overrideStars);
