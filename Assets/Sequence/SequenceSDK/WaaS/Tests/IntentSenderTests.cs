...
namespace Sequence.WaaS.Tests
{
    public class IntentSenderTests
    {
        ...
        public async Task TestTimeMismatchExceptionResultsInRetry(int timeOffset)
        {
            ...
            IntentSender intentSender = new IntentSender(new HttpClient($"{configJwt.rpcServer.AppendTrailingSlashIfNeeded()}rpc/WaasAuthenticator"), new EthWallet(), "", configJwt.projectId, config.WaaSVersion);
