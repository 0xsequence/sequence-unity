...
namespace Sequence.Ethereum.Tests
{
    public class RLPTest
    {
        ...
        public void RLPEncodingStandardTests()
        {
            ...
            byte[] dog_encoded = RLP.RLP.Encode(Encoding.UTF8.GetBytes("dog"));
            ...
            byte[] list_encoded = RLP.RLP.Encode(new List<object>() { Encoding.UTF8.GetBytes("cat"), Encoding.UTF8.GetBytes("dog") });
            ...
            byte[] helloworld_encoded = RLP.RLP.Encode(new List<object>() { Encoding.UTF8.GetBytes("hello"), Encoding.UTF8.GetBytes("world") });
            ...
            byte[] a_1024_encoded = RLP.RLP.Encode(Encoding.UTF8.GetBytes(a_1024));
            ...
            byte[] longList_encoded = RLP.RLP.Encode(longList);
        ...
        public void RLPDecodingStandardTests()
        {
            ...
            string dog_decoded = (string)RLP.RLP.Decode(dog_encoded);
            ...
            List<object> list_decoded = (List<object>)RLP.RLP.Decode(list_encoded);
            ...
            List<object> helloworld_decoded =(List<object>) RLP.RLP.Decode(helloworld_encoded);
            ...
            string a_1024 = new string('a', 1024);        
            byte[] a_1024_encoded = RLP.RLP.Encode(Encoding.UTF8.GetBytes(a_1024));
            string a_1024_decoded = (string)RLP.RLP.Decode(a_1024_encoded);
            Debug.Log(a_1024);
            ...
            byte[] longList_encoded = RLP.RLP.Encode(longList);
            List<object> longList_decoded = (List<object>)RLP.RLP.Decode(longList_encoded);
        ...
        public void RLPEncodingEmptyTests()
        {
            ...
            byte[] empty_string_encoded = RLP.RLP.Encode(Encoding.UTF8.GetBytes(""));
            ...
            byte[] empty_list_encoded = RLP.RLP.Encode(new List<object>());
            ...
            byte[] three_encoded = RLP.RLP.Encode(new List<object>() { new List<object>() { }, new List<object>() { new List<object>() { } }, new List<object>() { new List<object>() { }, new List<object>() { new List<object>() { } } } });
        ...
        public void RLPDecodingEmptyTests()
        {
            ...
            string empty_string_decoded = (string)RLP.RLP.Decode(new byte[] { 0x80 });
            ...
            List<object> empty_list_decoded =(List<object>)RLP.RLP.Decode(new byte[] { 0xc0 });
            ...
            List<object> three_decoded = (List<object>)RLP.RLP.Decode(new byte[] { 0xc7, 0xc0, 0xc1, 0xc0, 0xc3, 0xc0, 0xc1, 0xc0 });
        ...
        {
            //True
            Assert.AreEqual(new byte[] { 0x01 }, RLP.RLP.Encode(true));
            //False
            Assert.AreEqual(new byte[] { 0x80 }, RLP.RLP.Encode(false));
        }
        ...
        public void RLPEncodingStringTests()
        {
            ...
            byte[] string_1_encoded = RLP.RLP.Encode(Encoding.UTF8.GetBytes("Lorem ipsum dolor sit amet, consectetur adipisicing elit"));
        ...
        public void RLPEncodingIntegerTests()
        {
            ...
            byte[] integer_1_encoded = RLP.RLP.Encode(SequenceCoder.HexStringToByteArray(integer_1_str));
