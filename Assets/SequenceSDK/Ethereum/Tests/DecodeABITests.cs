...
namespace Sequence.Ethereum.Tests
{
    public class DecodeABITests
    {
        ...
        public void TestDecodeAbi(string abi, Dictionary<string, List<(string[], string)>> expected)
        {
            try
            {
                Dictionary<string, List<(string[], string)>> result = ABI.ABI.DecodeAbi(abi).Abi;
...
and in that case, my mission will be complete.";
        ...
        public void TestDecodeString(string expected, string value)
        {
            try
            {
                string result = ABI.ABI.Decode<string>(value, "string");
        ...
        public void TestDecodeString_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "string");
        ...
        public void TestDecodeAddress<T>(T expected, string value)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, "address");
        ...
        public void TestDecodeAddress_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "address");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeNumber<T>(T expected, string value)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, "uint256");
                Assert.AreEqual(expected.ToString(), result.ToString());
            }
            catch (Exception ex)
            {
        ...
        public void TestDecodeNumber_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "uint256");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeBool<T>(T expected, string value)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, "bool");
                Assert.AreEqual(expected.ToString(), result.ToString());
            }
            catch (Exception ex)
            {
        ...
        public void TestDecodeBool_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "bool");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeBytes(string value, byte[] expected)
        {
            try
            {
                byte[] result = ABI.ABI.Decode<byte[]>(value, "bytes");
                Assert.AreEqual(expected,  result);
            }
            catch (Exception ex)
            {
        ...
        public void TestDecodeBytes_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "bytes");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeFixedBytes<T>(int length, T expected, string value)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, $"bytes{length}");
        ...
        public void TestDecodeFixedBytes_maxSizeOf32ForFixedBytes()
        {
            try
            {
                ...
                FixedByte result = ABI.ABI.Decode<FixedByte>(value, "bytes33");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (Exception ex)
            {
        ...
        public void TestDecodeFixedBytes_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "bytes1");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeArray<T>(string value, T expected, string evmType)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, evmType);
        ...
        public void TestDecodeArray_throwsOnInvalidType<T>(T type)
        {
            ...
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "uint256[5]");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
        ...
        public void TestDecodeDynamicArray<T>(string value, T expected)
        {
            try
            {
                T result = ABI.ABI.Decode<T>(value, "(string[])");
        ...
        private static object[] DecodeNestedArrayTests_twoLayer =
        {
            ...
            new object[]
            {
                "",
                new []
                {
                    new string[] { "SDK by Horizon", "word", "", longMultiLineString},
                    new string[] { "SDK by Horizon", "word", "", longMultiLineString, " Hurray! "},
                    new string[] { "", "", "" },
                    new string[] { "SDK by Horizon"},
                    new string[] { },
                    new string[] { longMultiLineString, "SDK by Horizon" }
                },
                "(string[][])"
            }
        };
        ...
        public void TestDecodeNestedArray_twoLayer(string value, object[][] expected, string evmType)
        {
            try
            {
                object[][] result = ABI.ABI.Decode<object[][]>(value, evmType);
        ...
        public void TestDecodeTuple()
        {
            ...
            object[] result = ABI.ABI.Decode<object[]>(value, "(string, uint256[], uint256)");
        ...
        public void TestDecodeTuple_throwsOnInvalidType<T>(T type)
        {
            try
            {
                var result = ABI.ABI.Decode<T>("0x123", "(uint256, string)");
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (ArgumentException ex)
            {
