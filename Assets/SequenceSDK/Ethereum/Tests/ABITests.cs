...
namespace Sequence.Ethereum.Tests
{
    public class ABITests
    {
        ...
        public void DynamicArrayEncoding()
        {
            ...
            byte[] encoded = _arrayCoder.Encode(parameter, "uint256[]");
            CollectionAssert.AreEqual(expected, encoded);
        ...
        {
            string methodId = ABI.ABI.FunctionSelector("baz(uint32,bool)");
        ...
        {
            string methodId = ABI.ABI.FunctionSelector("sam(bytes,bool,uint256[])");
        ...
        {
            string methodId = ABI.ABI.FunctionSelector("f(uint256,uint32[],bytes10,bytes)");
        ...
        public void ABIPackTests()
        {
            ...
            Debug.Log("?");
            string encoded_data =ABI.ABI.Pack("balanceOf(address,uint256)", "0x6615e4e985bf0d137196897dfa182dbd7127f54f", 2);
        ...
        public void ExampleContractTests()
        {
            ...
            //
            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("baz(uint32,bool)", 69, true);
            ...
            }
            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("bar(bytes3[2])", new FixedByte[2] { new FixedByte(3, "abc"), new FixedByte(3, "def") });
                CollectionAssert.AreEqual(expected_data, abi_encoded_data);
            }
            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("sam(bytes,bool,uint256[])", "dave".ToByteArray(), true, new List<int>() { 1, 2, 3});
                CollectionAssert.AreEqual(expected_data, abi_encoded_data);
            }
            {
                string expected_data = "";
                string abi_encoded_data = ABI.ABI.Pack("sam(bytes,bool,uint256[])", "dave".ToByteArray(), true, new BigInteger[] { 1, 2, 3 });
                CollectionAssert.AreEqual(expected_data, abi_encoded_data);
            }
...

            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("f(uint256,uint32[],bytes10,bytes)", 0x123,new List<int>(){ 0x456, 0x789 }, new FixedByte(10,"1234567890"), "Hello, world!".ToByteArray());
                CollectionAssert.AreEqual(expected_data, abi_encoded_data);
            }
...

            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("g(uint256[][],string[])", new List<List<int>> { new List<int> { 1,2}, new List<int> { 3} }, new List<string> { "one", "two", "three"});
                CollectionAssert.AreEqual(expected_data, abi_encoded_data);
            }
            ...
            try
            {
                ...
                string abi_encoded_data = ABI.ABI.Pack("g(string[],uint256[][])", new List<List<int>> { new List<int> { 1,2}, new List<int> { 3} }, new List<string> { "one", "two", "three"});
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (Exception ex)
            {
                Assert.AreEqual("Error packing data: Argument type is not as expected. Expected: STRING Received: DYNAMICARRAY", ex.Message);
            }

            // Test exception thrown when improper types provided
            try
            {
                string abi_encoded_data = ABI.ABI.Pack("sam(bytes,bool,uint256[])", "dave", true, new List<int>() { 1, 2, 3 });
                Assert.Fail("Expected exception but none was thrown");
            }
            catch (Exception ex)
            {
