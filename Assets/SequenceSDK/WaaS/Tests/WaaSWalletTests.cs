...
namespace Sequence.WaaS.Tests
{
    public class WaaSWalletTests
    {
        ...
        public async Task TestSendBatchTransaction_withERC721()
        {
            ...
            if (erc721Balance == 0)
            {
                Debug.LogError($"Test {nameof(TestSendBatchTransaction_withERC721)} was not setup properly. {_address} must have an NFT from contract address: {_erc721Address}");
            ...
            TransactionReturn result = await _wallet.SendTransaction(new SendTransactionArgs(_address, Chain.Polygon,
                ...
                {
                    new SendERC20(_erc20Address, _toAddress, "1"),
                    new SendERC721(_erc721Address, _toAddress, "1"),
                    new RawTransaction(_toAddress, "1")
                }));
            ...
            GetTokenBalancesReturn newErc721Balances =
                await _polygonIndexer.GetTokenBalances(new GetTokenBalancesArgs(_address, _erc721Address));
            BigInteger newErc721Balance = newErc721Balances.balances[0].balance;
            ...
            CustomAssert.IsTrue(newErc721Balance == 0, nameof(TestSendBatchTransaction_withERC721));
        ...
        public async Task TestSendBatchTransaction_withERC1155()
        {
            ...
            {
                Debug.LogError($"Test {nameof(TestSendBatchTransaction_withERC1155)} was not setup properly. {_address} must have an SFT from contract address: {_erc1155Address}");
            ...
            CustomAssert.IsTrue(result is SuccessfulTransactionReturn, nameof(TestSendBatchTransaction_withERC1155));
            ...
            GetTokenBalancesReturn newErc1155Balances =
                await _polygonIndexer.GetTokenBalances(new GetTokenBalancesArgs(_address, _erc1155Address));
            BigInteger newErc721Balance = newErc1155Balances.balances[0].balance;
            BigInteger newBalance2 = await _client.BalanceAt(_toAddress);
            GetTokenBalancesReturn newErc20Balances2 =
                await _polygonIndexer.GetTokenBalances(new GetTokenBalancesArgs(_toAddress, _erc20Address));
            BigInteger newErc20Balance2 = newErc20Balances2.balances[0].balance;
            ...
            CustomAssert.IsTrue(newErc721Balance == 0, nameof(TestSendBatchTransaction_withERC1155));
