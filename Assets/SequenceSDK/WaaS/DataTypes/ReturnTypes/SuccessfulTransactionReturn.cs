...
namespace Sequence.WaaS
{
    ...
    public class SuccessfulTransactionReturn : TransactionReturn
    {
        ...
        public SuccessfulTransactionReturn(string txHash, string metaTxHash, IntentDataSendTransaction request, MetaTxnReceipt receipt, JObject nativeReceipt = null, SimulateResult[] simulations = null)
        {
            this.txHash = txHash;
